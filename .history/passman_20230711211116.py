...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.usernameInput.setGeometry(QtCore.QRect(390, 290, 161, 31))
        font = QtGui.QFont()
        ...
        self.username.setGeometry(QtCore.QRect(280, 290, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.password.setGeometry(QtCore.QRect(280, 340, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.passwordInput.setGeometry(QtCore.QRect(390, 340, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(14)
        ...
        self.websiteSubmitInput.setGeometry(QtCore.QRect(388, 400, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(14)
        ...
        self.websiteSubmit.setGeometry(QtCore.QRect(280, 400, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.keyword.setGeometry(QtCore.QRect(280, 460, 101, 20))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.keywordInput.setGeometry(QtCore.QRect(390, 460, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(14)
        ...
        self.websiteSearchInput.setGeometry(QtCore.QRect(740, 290, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(14)
        ...
        self.passcodeInput.setGeometry(QtCore.QRect(740, 340, 161, 31))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(14)
        ...
        self.outputBox.setGeometry(QtCore.QRect(642, 390, 261, 101))
        font = QtGui.QFont()
        font.setFamily("Montserrat")
        font.setPointSize(14)
        ...
        self.searchButton.setGeometry(QtCore.QRect(780, 520, 121, 41))
        font = QtGui.QFont()
    ...
    def submit(self):
        ...
        website = self.websiteSubmitInput.text()
        keyword = self.keywordInput.text()
        print(username, password, website, keyword)
    def search(self):
